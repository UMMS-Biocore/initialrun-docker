...
ENV PATH="/bin:/sbin:/usr/bin/samtools-1.9:/usr/bin/sratoolkit.2.10.6-ubuntu64/bin:${PATH}"
...
RUN cd /usr/bin && wget https://ftp-trace.ncbi.nlm.nih.gov/sra/sdk/2.10.6/sratoolkit.2.10.6-ubuntu64.tar.gz && \ 
    tar -xvzf sratoolkit.2.10.6-ubuntu64.tar.gz
